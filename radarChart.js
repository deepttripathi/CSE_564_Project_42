...
function RadarChart(data,country_name) {
    var cfg = {
    ...
    d3.json("world_countries.json", (data)=>{
      console.log(data)
    })
    // console.log(data)
    ...
    fieldNames= ["GDP per capita","Social support","Healthy life expectancy","Freedom to make life choices","Generosity",
